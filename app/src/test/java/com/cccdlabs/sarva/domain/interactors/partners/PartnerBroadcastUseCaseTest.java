...
public class PartnerBroadcastUseCaseTest {
    ...
    private NearbyPartnerBroadcast mNearbyMock;

    @Before
    public void setUp() throws Exception {
        mNearbyMock = mock(NearbyPartnerBroadcast.class);
    }
    ...
    public void shouldEmitPartners() throws Exception {
        ...
        PartnerBroadcastUseCase useCase = new PartnerBroadcastUseCase(mNearbyMock);
