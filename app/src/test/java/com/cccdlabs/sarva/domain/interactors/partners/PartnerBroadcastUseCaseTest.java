...
public class PartnerBroadcastUseCaseTest {

    private PartnerBroadcastEmitter mEmitterMock;

    @Before
    public void setUp() throws Exception {
        mEmitterMock = mock(PartnerBroadcastEmitter.class);
    }
    ...
    public void shouldEmitPartners() throws Exception {
        ...
        PartnerBroadcastUseCase useCase = new PartnerBroadcastUseCase(mEmitterMock);
    ...
    @Test
    public void shouldEmitExceptionInResult() throws Exception {
