...
public class PartnerTransmitterUseCaseTest {
    ...
    private NearbyPartnerTransmitter mNearbyMock;

    @Before
    public void setUp() throws Exception {
        mNearbyMock = mock(NearbyPartnerTransmitter.class);
    }
    ...
    public void shouldEmitPartners() throws Exception {
        ...
        PartnerTransmitterUseCase useCase = new PartnerTransmitterUseCase(mNearbyMock);
