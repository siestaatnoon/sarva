...
public class PartnerTransmitterUseCaseTest {

    private PartnerTransmitterEmitter mEmitterMock;

    @Before
    public void setUp() throws Exception {
        mEmitterMock = mock(PartnerTransmitterEmitter.class);
    }
    ...
    public void shouldEmitPartners() throws Exception {
        ...
        PartnerTransmitterUseCase useCase = new PartnerTransmitterUseCase(mEmitterMock);
