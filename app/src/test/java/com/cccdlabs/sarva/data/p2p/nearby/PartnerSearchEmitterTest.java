...
public class PartnerSearchEmitterTest {
    ...
    private PartnerSearchEmitter mEmitter;
    ...
    class MockPartnerSearchEmitter extends PartnerSearchEmitter {

        private Context context;
        private MockMessagesClient mockMessagesClient;

        MockPartnerSearchEmitter(Context context, MockMessagesClient mockMessagesClient, PartnerRepository repository) {
    ...
    public void setup() throws Exception {
        ...
        mEmitter = new MockPartnerSearchEmitter(context, mClient, mRepository);
