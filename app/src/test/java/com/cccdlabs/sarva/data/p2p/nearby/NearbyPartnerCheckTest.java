...
public class NearbyPartnerCheckTest {

    private static final String OBJECT_NAME = "NearbyPartnerCheck";
    ...
    private NearbyPartnerCheck mNearby;
    private PartnerRepository mRepository;
    private GeneralSettingsManager mSettings;

    class MockNearbyPartnerCheck extends NearbyPartnerCheck {

        MockNearbyPartnerCheck(Context context, PartnerRepository repository) {
    ...
    public void setup() throws Exception {
        ...
        mNearby = new MockNearbyPartnerCheck(context, mRepository);
    }
