...
public class PartnerCheckEmitterTest {
    ...
    private PartnerCheckEmitter mEmitter;
    ...
    class MockPartnerCheckEmitter extends PartnerCheckEmitter {

        private Context context;
        private MockMessagesClient mockMessagesClient;

        MockPartnerCheckEmitter(Context context, MockMessagesClient mockMessagesClient, PartnerRepository repository) {
    ...
    public void setup() throws Exception {
        ...
        mEmitter = new MockPartnerCheckEmitter(context, mClient, mRepository);
    ...
    public void testOnPublishExpiredEmitsPartnerResult() throws Throwable {
        TestSubscriber<PartnerResult> subscriber = new TestSubscriber<PartnerResult>() {
            ...
            public void onNext(PartnerResult partnerResult) {
                ...
                // At one point, OnPublishExpired emitted an exception
                // but currently it doesn't

                else if (count == 2) {
                    assertTrue("PartnerResult hasError() false", partnerResult.hasError());
                    assertTrue(
                            "PartnerResult exception not of PublishExpiredException",
                            partnerResult.getException() instanceof PublishExpiredException
                    );
                }
                */
                count++;
        ...
        TestSubscriber<PartnerResult> subscriber = new TestSubscriber<PartnerResult>() {
            ...
            public void onNext(PartnerResult partnerResult) {
                ...
                // but currently it doesn't
                    ...
                    assertTrue("PartnerResult hasError() false", partnerResult.hasError());
                    assertTrue(
                            "PartnerResult exception not of SubscribeExpiredException",
                            partnerResult.getException() instanceof SubscribeExpiredException
                    );
                }
                */
