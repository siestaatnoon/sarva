...
public class PartnerTransmitterEmitterTest {
    ...
    private PartnerTransmitterEmitter mEmitter;
    ...
    class MockPartnerTransmitterEmitter extends PartnerTransmitterEmitter {

        private Context context;
        private MockMessagesClient mockMessagesClient;

        MockPartnerTransmitterEmitter(Context context, MockMessagesClient mockMessagesClient, PartnerRepository repository) {
    ...
    public void setup() throws Exception {
        ...
        mEmitter = new MockPartnerTransmitterEmitter(context, mClient, mRepository);
