...
/**
 * {@link com.cccdlabs.sarva.domain.interactors.base.UseCase} to retrieve {@link Partner}s
 * marked active that are saved on this device from a data source.
 *
 * @author Johnny Spence
 * @version 1.0.0
 */
public class GetActivePartnersUseCase extends AbstractUseCase<Void, List<Partner>> {
     ...
     */
    @Inject
    public GetActivePartnersUseCase(@NonNull PartnerRepository repository) {
        this.repository = repository;
    }

    /**
     * Returns a {@link List} of the active {@link Partner}s saved on this device.
     *
